document.addEventListener('DOMContentLoaded', function(){
  // 新規投稿・編集ページのフォームを取得
  const itemForm = document.getElementById('item-images');
  ...
  const buildPreviewImage = (dataIndex, blob) =>{
    ...
    previewImage.setAttribute('class', 'item-image');
  ...
  const buildNewFileField = () => {
    ...
    // 最後のfile_fieldを取得
    const lastFileField = document.querySelector('item[type="file"][name="item[images][]"]:last-child');
